        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">Pertanahan</span>
                </a>
            ...
            <div x-data="header"
                ...
                <h1 class="text-bold">PERTANAHAN</h1>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        @auth
                            ...
                            <li class="border-t border-white-light dark:border-white-light/10">
                                <form method="POST" action="{{ route('logout') }}" class="w-full">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left text-danger !py-3 flex items-center hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        @else
                            <li>
                                <a href="{{ route('login') }}"
                                    class="block px-4 py-3 text-center hover:bg-gray-100 dark:hover:bg-gray-700">
