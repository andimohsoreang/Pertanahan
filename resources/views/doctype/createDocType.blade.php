    ...
    <div class="pt-5 grid grid-cols-1 xl:grid-cols-1 gap-6" x-data="form">
        <div class="panel">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Add Document Type</h5>
            </div>
            <div class="mb-5">
                <form class="space-y-5" method="POST" action="{{ route('type.store') }}">
                    @csrf
                    <!-- Document Type -->
                    <div :class="[isSubmitForm1 ? (form1.jenis_dokumen ? 'has-success' : 'has-error') : '']">
                        ...
                        <input id="jenis_dokumen" name="jenis_dokumen" type="text" placeholder="Enter Document Type"
                            class="form-input" x-model="form1.jenis_dokumen" />
                        @error('jenis_dokumen')
